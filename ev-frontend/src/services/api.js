...
export const aiApi = {
  ...
  monthlyReport: (payload) => api.post("/ai/reports/monthly", payload),
  history: (params) => api.get("/ai/history", { params }),
  historyBySession: (sessionId, params) => api.get(`/ai/history/${sessionId}`, { params }),
  deleteHistory: (sessionId, params) => api.delete(`/ai/history/${sessionId}`, { params }),
